...
import { patchMenu, startExperimentWorkflow } from "./actions";
...
export default function ExperimentsPage() {
  ...
  const { selectedMenuInstance, isLoadingMenuInstances, jwtToken, refreshMenuInstances, rawOwnerId, selectedMenuOwnerId } = useAuth();
  ...
  const handleToggleClick = async () => {
    if (selectedMenuInstance) {
      ...
      if (result.success) {
        toast({
          title: `Experiments ${!currentStatus ? 'Enabled' : 'Disabled'}`,
  ...
  const handleGoalSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!patchResult.success) {
        throw new Error(patchResult.message || "Failed to set the experiment goal.");
      }

      toast({
        title: "Goal Set Successfully",
        description: "Your goal has been saved. Initiating experiment workflow.",
      });
        ...
        try {
          ...
          if (!startResult.success) {
            toast({
              ...
              description: startResult.message || "Could not start the backend experiment workflow.",
              variant: "destructive",
            });
          } else {
            toast({
              title: "Experiment Initiated",
  ...
  if (!selectedMenuInstance) {
    return (
      <Alert variant="default" className="border-primary/50 bg-primary/5">
        ...
        <AlertDescriptionUI>
          Please select a menu instance to manage Experiments.
        </AlertDescriptionUI>
      </Alert>
    );
  }
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Enable AI-powered menu experiments to automatically improve revenue.
          </p>
        </div>
        <Card className="shadow-lg bg-secondary/30">
          <CardHeader>
            <CardTitle className="flex items-center text-2xl">
              ...
              What are AI-Powered Experiments?
            </CardTitle>
            <CardDescription>
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-muted-foreground mt-2 max-w-3xl">
            Review AI-generated experiments designed to achieve your goals. When active, this experiment shows a modified menu to 50% of your customers to test the hypothesis. You can disable testing at any time or provide a new goal for the AI.
          </p>
        </div>
            ...
            <>
              <CardHeader className="flex flex-row items-start justify-between">
                <div>
                  ...
                  <CardDescription>
                    An experiment is running with the goal below.
                  </CardDescription>
                </div>
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="max-w-xs">Updating the goal will interrupt the current experiment and start a new one.</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </CardHeader>
            ...
            <CardContent className="space-y-3">
              {significantChanges.length > 0 ? (
                ...
                <div className="text-center py-10 text-muted-foreground">
                  ...
                  <p>No significant menu changes are part of this experiment.</p>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center text-2xl">
              ...
              Experiment History & Evaluations
            </CardTitle>
            <CardDescription>
              History of currently running experiments and their daily evaluations.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {selectedMenuInstance.testHistory ? (
              ...
              <div className="text-center py-10 text-muted-foreground">
                ...
                <p>No experiment history available yet.</p>
              </div>
            )}
          </CardContent>
        </Card>
